...
export default function ReportsSection() {
    return (
        <section className="pt-[clamp(60px,8vw,100px)] pb-[clamp(60px,8vw,100px)] relative" style={{ overflowX: 'clip' }}>
            {/* Heading */}
            <div className="mb-10" style={{ paddingLeft: 'clamp(30px, 15vw, 240px)' }}>
            ...
            <div className="reports-swiper-wrap" style={{ paddingLeft: 'clamp(30px, 8vw, 100px)' }}>
                <Swiper
                ...
                >
                    {REPORTS.map((report, i) => (
                        <SwiperSlide key={i}>
                            <Link
                                to={report.href}
                                className="no-underline flex flex-row items-stretch rounded-2xl overflow-hidden transition-all duration-200 group p-8 bg-glass-effect"
                            >
                                {/* Left — text content */}
                                ...
                                <div className={`w-[42%] shrink-0`} >
                                    <img src={report.imgClass} alt={report.title} className='rounded-3xl'/>
                                </div>
