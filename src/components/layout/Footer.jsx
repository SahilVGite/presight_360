...
import { siteLogo, siteShortLogo } from '../../assets/images';
            ...
            <div>
              ...
              <ul className="flex-wrap gap-x-8 gap-y-4 block space-y-7 pl-4 md:pl-12">
                {FOOTER_LINKS.map((link) => (
                  <li key={link.path}>
                    <Link href={link.path} className="[font-size:var(--fs-body)] md:[font-size:var(--fs-body-md)] text-white font-medium">
                      {link.label}
                    </Link>
                  </li>
                ))}
            ...
            <div className="flex flex-row sm:flex-col justify-between items-end sm:items-end gap-8 mt-12 md:mt-20">
              <ul className="flex flex-wrap gap-x-8 gap-y-5 sm:gap-12">
                <li>
                  ...
                  <a href="tel:+62899077632" className="[font-size:var(--fs-body-xs)] md:[font-size:var(--fs-body-sm)] text-white font-medium">+62 899 077 632</a>
                </li>
                <li>
                  <p className="mb-2 text-[calc(var(--fs-body-xs)-2px)] text-white font-medium uppercase">Phone</p>
                  <a href="tel:+62556783472" className="[font-size:var(--fs-body-xs)] md:[font-size:var(--fs-body-sm)] text-white font-medium">+62 556 783 472</a>
                </li>
                <li>
                  <p className="mb-2 text-[calc(var(--fs-body-xs)-2px)] text-white font-medium uppercase">Email</p>
                  <a href="mailto:Mindora@gmail.com" className="[font-size:var(--fs-body-xs)] md:[font-size:var(--fs-body-sm)] text-white font-medium">Mindora@gmail.com</a>
                </li>
              </ul>
              ...
              <div className="flex items-center gap-4 md:gap-5 shrink-0">
                ...
                <ul className="grid grid-cols-2 gap-2 items-center">
                  <li>
                    <Link href="/" className="rounded-full border border-white p-[11px] md:p-[13px] flex items-center justify-center w-9 h-9 md:w-10 md:h-10">
