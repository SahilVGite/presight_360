          ...
          <div className='w-full'>
            ...
            <div className='flex justify-between mt-20'>
                ...
                <div className='flex items-center gap-5'>
                    <button onClick={scrollToTop} className='flex items-center gap-2 text-sm text-white font-medium uppercase tracking-widest rounded-full border-1 border-white p-8 cursor-pointer'>
                        <ArrowUp size={24} />
                    </button>
