...
export const JOBS_DATA = [
  { id: 1, title: 'Sr. Manager', openings: 1, experience: '7+ years', location: 'Area name, Location', skills: ['Curriculum Designing & Management', 'Good Communication Skills', 'University, School Co-ordination', 'Open for learning'], desc: 'Lead strategic initiatives and manage a high-performing team in a fast-paced, intelligence-driven environment.' },
  { id: 2, title: 'Intelligence Analyst', openings: 2, experience: '3+ years', location: 'Remote / On-site', skills: ['Research & Analysis', 'Geopolitical Knowledge', 'Report Writing', 'Data Interpretation'], desc: 'Analyze global threat environments and produce actionable intelligence reports for senior leadership.' },
  { id: 3, title: 'Security Operations Specialist', openings: 1, experience: '5+ years', location: 'Area name, Location', skills: ['Security Operations', 'Risk Assessment', 'Crisis Response', 'Team Leadership'], desc: 'Oversee day-to-day security operations and coordinate with field teams across multiple jurisdictions.' },
  { id: 4, title: 'Intern UI/Frontend Developer', openings: 2, experience: '0-1 years', location: 'Remote', skills: ['React', 'Tailwind CSS', 'Figma', 'HTML/CSS'], desc: 'Join our digital team and help build cutting-edge intelligence platforms and internal tools.' },
];
      ...
      >
        <div>
          ...
          <div className="flex flex-wrap gap-2 text-xs">
            <span className="px-2 py-1 rounded bg-blue-dim text-secondary\/80">Open positions: {job.openings}</span>
            <span className="px-2 py-1 rounded bg-white-06 text-secondary\/70">{job.experience}</span>
        ...
        <div className="px-6 pb-6">
          ...
          <ul className="space-y-1 mb-5">
            {[job.desc, 'This is dummy text will be replaced with original content.', 'This is dummy text will be replaced with original content.'].map((item, i) => (
              <li key={i} className="text-xs flex gap-2 text-secondary\/65 leading-[1.7]">
          ...
          <div className="flex justify-end">
            <Link to={`/careers/${job.id}/apply`} className="btn-primary px-5 py-2 text-sm no-underline">
              Apply Now
            </Link>
          </div>
        </div>
    ...
    <>
      ...
      <section className="py-[60px] px-6 bg-secondary">
        <div className="max-w-6xl mx-auto">
          ...
          <h2 className="section-title mb-6 max-w-[780px] text-[clamp(1.3rem,3vw,2rem)]">
          ...
          <p className="text-sm leading-relaxed max-w-3xl text-secondary\/70">
      ...
      <section className="py-[60px] px-6 bg-primary">
        <div className="max-w-6xl mx-auto">
          <h2 className="section-title text-center mb-2 text-accent-red">Search Jobs</h2>
          ...
          <div className="max-w-4xl mx-auto">
            {filtered.length === 0 ? (
              <p className="text-center text-sm text-secondary\/50">No openings match your search.</p>
            ) : (
      ...
      <section className="py-[60px] px-6 bg-secondary">
        <div className="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-6">
          {[
            { title: 'Success Stories', desc: 'Success Stories showcase real-world impact through client achievements, solved challenges, and measurable outcomes, highlighting how our intelligence-led insights and risk solutions drive confident decisions and lasting value.' },
            { title: 'Life At Presight360', desc: 'Life at Presight360 is about collaboration, curiosity, and purpose. We foster a culture where ideas are valued, growth is encouraged, and people work together to solve complex challenges with integrity, innovation, and impact.' },
          ].map((card, i) => (
